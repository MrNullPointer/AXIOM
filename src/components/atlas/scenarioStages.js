...
export const SCENARIO_STAGES = [
  ...
  },
  {
    ...
    desc: 'The 64-byte cacheline rides back through the hierarchy. In this inclusive example it lands in L3 + L2 + L1, so the next access to anything nearby hits L1.',
    latency: '15 cycles',
  ...
  },
  {
    ...
    desc: 'A cache hit would have cost 4 cycles. We paid 287 because the line was cold — 70× slower. The good news: the 64 B that just landed turns subsequent reads into L1 hits at ~4 cyc each. That is locality, and it is the only thing that makes computers fast.',
    latency: '—',
    cumulative: '~287 cycles',
  },
];
